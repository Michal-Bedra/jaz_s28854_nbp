...
public class CurrencyController {
    ...
    public ResponseEntity<Double> getCurrency(@PathVariable String currencyCode, @RequestParam(defaultValue = "1") Integer last) throws CurrencyServiceException {
        return new ResponseEntity<>(currencyService.getAverageRate(currencyCode, last), HttpStatus.OK);
    }
